...
basic.forever(function () {
    ...
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S1, 200)
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S2, 200)
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S3, 200)
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S4, 200)
    basic.pause(1000)

    // S1--S4 PWM interface output 0 value, 0% duty cycle.
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S1, 0)
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S2, 0)
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S3, 0)
    mShield.extendPwmControl(mShield.PwmAndServoIndex.S4, 0)
    basic.pause(1000)
    ...
    mShield.extendServoControl(mShield.PwmAndServoIndex.S2, mShield.ServoType.Servo180, 0)
    mShield.extendServoControl(mShield.PwmAndServoIndex.S3, mShield.ServoType.Servo180, 0)
    mShield.extendServoControl(mShield.PwmAndServoIndex.S4, mShield.ServoType.Servo180, 0)
    basic.pause(1000)
    ...
    mShield.extendServoControl(mShield.PwmAndServoIndex.S2, mShield.ServoType.Servo180, 180)
    mShield.extendServoControl(mShield.PwmAndServoIndex.S3, mShield.ServoType.Servo180, 180)
    mShield.extendServoControl(mShield.PwmAndServoIndex.S4, mShield.ServoType.Servo180, 180)
    basic.pause(1000)
    ...
    mShield.continuousServoControl(mShield.PwmAndServoIndex.S1, 100)
    basic.pause(1000)

    // 360-degree servo stop.
    mShield.continuousServoControl(mShield.PwmAndServoIndex.S1, 0)
    basic.pause(1000)
